...
// SimpleClient -- A stream of IRC events
//
// Emits:
...
//
var SimpleClient = exports.SimpleClient = pre.defclass(events.EventEmitter, {

    init: function(opt) {
        SimpleClient.super_.call(this);
        this.options = opt;
...
//
var Client = exports.Client = pre.defclass(SimpleClient, {

    init: function(opt) {
        Client.super_.apply(this, arguments);
    },

    handlers: pre.merge(SimpleClient.prototype.handlers, {
        connect: function() {
            this._input();
...
var parse = exports.parse = function (line) {
    ...
    var nick = /^([^!]+)!(.*)$/.exec(parts[1]);

    return {
        line: line,
        prefix: parts[1],
        nick: nick ? nick[1] : parts[1],
        host: nick ? nick[2] : parts[1],
